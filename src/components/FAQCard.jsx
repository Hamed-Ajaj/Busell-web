...
const FAQCard = ({  title, desc, id }) => {
  ...
  return (
      <section className="faq-card py-[1.3rem] px-4 md:px-8  self-start rounded-[1.25rem] border border-[#5D5D5D]">
        <div className="flex items-center justify-start gap-x-7">
          ...
          <h1 className="text-black text-[0.9rem] font-[500] md:text-[1.5rem] ">{title}</h1>
        </div>
        {open && (
          <div>
