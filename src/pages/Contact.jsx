...
const Contact = () => {
  ...
  scrollToTop();
  return (
    <section className="mt-20 flex flex-col md:px-12 px-4 py-12 gap-8 justify-center items-center">
      <div className="flex w-full mb-10 md:mb-0  md:py-12 flex-col space-y-16 md:space-y-10 justify-center items-center sm:items-start sm:justify-start md:items-start md:justify-start">
        ...
        <div className="flex flex-col gap-y-10 md:flex-row  md:gap-x-16 justify-center items-center">
          <div className="flex self-start flex-row max-w-[242px] gap-x-8 md:justify-center md:items-center">
            ...
            <p className="text-black text-[1.125rem] font-[400]">
              Call Us <br /> +961 12345678
            </p>
          </div>
          <div className="flex self-start flex-row max-w-[242px] gap-x-8 md:justify-center md:items-center">
            ...
            <p className="text-black text-[1.125rem] font-[400]">
              Send Us On Email <br /> hamed@gmail.com
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center md:justify-center lg:justify-between md:mt-12 flex-col md:flex-row items-center w-full gap-[2.5rem]">
        <div className="flex flex-col gap-y-10 sm:self-start md:self-start md:w-1/2">
          <h1 className="text-black text-[2rem] font-[500] md:text-[3rem]">
            Get In Touch!
          </h1>
          <p className="text-[1.125rem] text-[#C2C2C2] font-[400] ">
            Need Any Help? Send us a message using the form <br /> below and
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="flex justify-center items-center flex-col min-w-[300px] max-w-[500px] gap-y-5">
              <input
                ...
                id="name"
                placeholder="Name"
                className={` w-full h-14 px-5 rounded-full border-[1px] ${errors.name ? "border-red-500" : "border-[#C2C2C2]"} outline-none`}
                {...register("name", {
              ...
              <input
                ...
                id="email"
                placeholder="Email"
                className="w-full h-14 px-5 rounded-full border-[1px] border-[#C2C2C2] outline-none"
                {...register("email", {
              ...
              <textarea
                ...
                id="message"
                placeholder="Message"
                className="w-full resize-none h-40 px-5 py-4 rounded-3xl border-[1px] border-[#C2C2C2] outline-none"
                {...register("message")}
              ></textarea>
              <button
                type="submit"
                className="w-full flex justify-center items-center h-14 bg-black text-white text-[1.125rem] font-[500] rounded-full"
              >
                Send Message
              </button>
            </div>
