      ...
      <div className="w-full py-[1rem] px-[1rem] md:py-[3.6rem] md:px-[6.2rem] flex flex-col ">
        <div className="flex flex-col gap-y-6 md:items-center md:justify-center">
          ...
          <p className="md:text-center text-[#BEC0C7] text-[1rem] md:text-[1.2rem] md:font-[400]">
            A collection of high-performing and well-designed Framer{" "}
            <br className="hidden md:block" /> templates to set up your website
          </p>
        </div>
        <div className="flex flex-col gap-y-6 md:gap-x-6 items-center justify-center md:flex-row mt-10">
          <div className="relative w-2/3 md:w-1/3 w-full ">
            <img
              src={search}
              alt="search icon "
            ...
            <input
              ...
              className="bg-[#07070C] outline-none border-none text-white p-6 px-16 placeholder:text-[1rem] placeholder:font-[400] placeholder:text-white rounded-3xl w-full min-w-[10rem]"
            />
          </div>
          <div className="grid grid-cols-2 justify-center items-center gap-y-4 sm:grid-cols-3 md:gap-y-0 columns-auto gap-x-5">
            <button
              ...
              className={`${activeButton === "template" ? "primary-btn-lg" : "gray-btn-lg"} flex justify-center items-center w-auto`}
            >
              Template
            </button>
            <button
              onClick={() => handleButtonClick("resources")}
              className={`${activeButton === "resources" ? "primary-btn-lg" : "gray-btn-lg"} w-auto flex justify-center items-center`}
            >
              Resources
            </button>
            <button
              onClick={() => handleButtonClick("articles")}
              className={`${activeButton === "articles" ? "primary-btn-lg" : "gray-btn-lg"} w-auto flex justify-center items-center`}
            >
              Articles
            </button>
          </div>
